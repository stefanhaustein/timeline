...
/* Periods */
  ...
  upper_cretaceous        : [166, 216, 74],
  lower_cretaceous        : [140, 205, 87],

  upper_jurassic          : [179, 227, 239],
  middle_jurassic         : [128, 207, 216],
  lower_jurassic          : [ 66, 174, 208],

  upper_triassic          : [189, 140, 195],
  middle_triassic         : [177, 104, 177],
  lower_triassic          : [125,  57, 153],
  lopingian               : [251, 167, 148],
  guadalupian             : [251, 116, 92],
  cisuralian              : [239,  88, 69],

  upper_pennsylvanian     : [191, 208, 186],
  middle_pennsylvanian    : [166, 199, 183],
  lower_pennsylvanian     : [140, 190, 180],
  upper_mississippian     : [179, 190, 108],
  middle_mississippian    : [153, 180, 108],
  lower_mississippian     : [128, 171, 108],

  upper_devonian          : [241, 225, 157],
  middle_devonian         : [241, 200, 104],
  lower_devonian          : [229, 172, 77],
  ...
  upper_ordovician        : [127, 202, 147],
  middle_ordovician       : [ 77, 180, 126],
  lower_ordovician        : [ 26, 157, 111],
  furongian               : [179, 224, 149],
  cambrian_series_3       : [166, 207, 134],
  cambrian_series_2       : [153, 192, 120],
  ...
  cambrian_stage_10       : [230, 245, 201],
  cambrian_stage_9        : [217, 240, 187],
  paibian                 : [204, 235, 174],

  guzhangian              : [204, 223, 170],
  drumian                 : [191, 217, 157],
  cambrian_stage_5        : [179, 212, 146],

  cambrian_stage_4        : [179, 202, 142],
  cambrian_stage_3        : [166, 197, 131],

  cambrian_stage_2        : [166, 186, 128],
